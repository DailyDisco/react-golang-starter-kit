...
interface InputProps extends React.ComponentProps<'input'> {
  /** Explicitly mark input as having an error (triggers shake animation) */
  error?: boolean;
  /** Mark input as valid/success state (shows green ring) */
  success?: boolean;
}
  ...
  return (
    <input
      ...
      className={cn(
        ...
        'data-[error=true]:border-destructive data-[error=true]:ring-destructive/20 data-[error=true]:animate-shake',
        'data-[success=true]:border-success data-[success=true]:ring-success/20 dark:data-[success=true]:ring-success/30',
        className
      )}
      {...props}
    />

  ...
  return (
    <main className="min-h-screen bg-gray-50 px-4 py-8 dark:bg-gray-900">
      <div className="mx-auto max-w-4xl space-y-8">
        ...
        >
          <h1 className="mb-2 text-4xl font-bold text-gray-900 dark:text-white">React + Go Integration Test</h1>
          <p className="text-gray-600 dark:text-gray-300">Test your backend API endpoints from this React frontend</p>
        </motion.header>

        {/* Health Check Section */}
        <section className="rounded-lg bg-white p-6 shadow-md dark:bg-gray-800">
          <h2 className="mb-4 text-2xl font-semibold text-gray-900 dark:text-white">🔍 Health Check</h2>
            ...
            {healthStatus && (
              <div className="space-y-3">
                ...
                >
                  ...
                  >
                    {healthStatus.overall_status === "healthy" ? "✅" : "❌"} Overall Status:{" "}
                ...
                {/* Component Statuses */}
                {healthStatus.components && healthStatus.components.length > 0 && (
                  <div className="space-y-2">
                    <h4 className="text-sm font-medium text-gray-700 dark:text-gray-300">Component Details:</h4>
                    {healthStatus.components.map((component, index) => (
                      ...
                      >
                        ...
                        {component.message && (
                          <p className="mt-1 text-xs text-gray-600 dark:text-gray-400">{component.message}</p>
                        )}
                      </div>
                    ))}
                  </div>
        ...
        {/* Create User Section */}
        <section className="rounded-lg bg-white p-6 shadow-md dark:bg-gray-800">
          <h2 className="mb-4 text-2xl font-semibold text-gray-900 dark:text-white">👤 Create User</h2>
          <form
        ...
        {/* File Upload Section */}
        <section className="rounded-lg bg-white p-6 shadow-md dark:bg-gray-800">
          <h2 className="mb-4 text-2xl font-semibold text-gray-900 dark:text-white">📁 File Upload Demo</h2>
          <p className="mb-6 text-gray-600 dark:text-gray-300">
            Upload files to the server. Files are automatically stored in S3 if configured, otherwise stored in the
            database.{" "}
            <strong className="text-blue-600 dark:text-blue-400">You must be logged in to upload files.</strong>
          </p>
          ...
          <div className="space-y-4">
                    ...
                    <div className="mt-3 flex items-center justify-center space-x-2">
                      <div
                        className={`h-2 w-2 rounded-full ${
                          storageStatus.storage_type === "s3" ? "bg-green-500" : "bg-orange-500"
                        }`}
                      />
            ...
            {storageStatus && storageStatus.storage_type && (
              <div className="rounded-lg border border-blue-300 bg-blue-50 p-4 dark:border-blue-700 dark:bg-blue-900/20">
                ...
                <p className="mt-1 text-sm text-blue-600 dark:text-blue-400">{storageStatus.message}</p>
              </div>
            )}
          </div>
        </section>
        ...
        <section className="rounded-lg bg-white p-6 shadow-md dark:bg-gray-800">
          <div className="mb-4 flex items-center justify-between">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white">📂 Uploaded Files</h2>
            <button
              onClick={() => {
          ...
          {filesLoading ? (
            ...
            <div className="py-8 text-center">
              <p className="text-gray-500 dark:text-gray-400">
                {files === undefined ? "Please log in to view your files" : "No files uploaded yet. Upload one above!"}
              </p>
            </div>
          ) : (
            <div className="space-y-4">
        ...
        <section className="rounded-lg bg-white p-6 shadow-md dark:bg-gray-800">
          <div className="mb-4 flex items-center justify-between">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white">📋 Users List</h2>
            <button
              onClick={() => {
                if ((users || []).length > 0) {
              ...
              <table className="w-full border-collapse">
                <thead>
                  <tr className="border-b border-gray-200 dark:border-gray-600">
                    <th className="px-4 py-2 text-left font-medium text-gray-900 dark:text-white">ID</th>
                    ...
                    <th className="px-4 py-2 text-left font-medium text-gray-900 dark:text-white">Actions</th>
                  </tr>
                </thead>
                <AnimatePresence>
                  {(() => {
        ...
        {/* Backend Status */}
        <section className="rounded-lg bg-white p-6 shadow-md dark:bg-gray-800">
          <h2 className="mb-4 text-2xl font-semibold text-gray-900 dark:text-white">🔧 Backend Status</h2>
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div className="rounded-lg bg-gray-100 p-4 dark:bg-gray-700">
              <h3 className="mb-2 font-medium text-gray-900 dark:text-white">API Endpoints</h3>
            ...
            <div className="rounded-lg bg-gray-100 p-4 dark:bg-gray-700">
              <h3 className="mb-2 font-medium text-gray-900 dark:text-white">Server Details</h3>
              <ul className="space-y-1 text-sm text-gray-600 dark:text-gray-300">
